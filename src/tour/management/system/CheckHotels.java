...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l2.setVisible(true);
            caption.setText("Aloft Hotel");
            l2.add(caption);
            Thread.sleep(2800);
            l2.setVisible(false);
            l3.setVisible(true);
            caption.setText("Dwarikas Hotel");
            l3.add(caption);
            l3.setVisible(true);
            Thread.sleep(2800);
            l3.setVisible(false);
            l4.setVisible(true);
            caption.setText("Hyatt Regency Hotel");
            l4.add(caption);
            Thread.sleep(2800);
            l4.setVisible(false);
            l5.setVisible(true);
            caption.setText("Milit Hotel");
            l5.add(caption);
            Thread.sleep(2800);
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("Yak Hotel");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            caption.setText("Malla Hotel");
            l7.add(caption);
            Thread.sleep(2800);
            l7.setVisible(false);
            l8.setVisible(true);
            caption.setText("Soaltee Hotel");
            l8.add(caption);
            Thread.sleep(2800);
            l8.setVisible(false);
            l9.setVisible(true);
            caption.setText("Gokarna Resort");
            l9.add(caption);
            Thread.sleep(2800);
            l9.setVisible(false);
            l10.setVisible(true);
    ...
    public CheckHotels() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/hotel1.webp"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/hotel2.webp"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/hotel5.jfif"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/hotel6.jpeg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/hotel7.jfif"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/hotel8.jfif"));
